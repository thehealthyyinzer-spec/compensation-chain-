...
export const MOVES: Record<string, Move> = {
  ...
  ankle: {
    ...
    region: ["ankles"],
    capacity: true,
    desc: "Knee-to-wall test. Left 4s + right 4s. Foot next to wall, drive knee to touch.",
    phases: [
      {
        view: "side",
        hold: 4,
        leg: "Left",
        instruction: "<strong>Ankle · LEFT foot</strong>Stand sideways. Place your LEFT foot a few inches from a wall (or just use the floor). Drive your knee forward toward the wall — or as far as it goes. Heel stays down. That's it. 4 seconds.",
        holdHint: "Knee forward, heel down…",
        trigger: (v: any) => v.isSideOn && v.shinAngle > 3,
        triggerMsg: "Turn sideways — left foot forward, drive that knee",
        metrics: [
      ...
      },
      {
        ...
        hold: 4,
        leg: "Right",
        instruction: "<strong>Ankle · RIGHT foot</strong>Switch sides — RIGHT foot forward. Same thing. Drive the knee forward, heel stays down. 4 seconds.",
        holdHint: "Knee forward, heel down…",
        trigger: (v: any) => v.isSideOn && v.shinAngle > 3,
        triggerMsg: "Switch — right foot forward, drive the knee",
        metrics: [
...
/**
 * Research-informed screening ranges.
 * These ranges guide coaching conversations; they are not medical cutoffs.
 */
export const BENCHMARKS: Record<string, any> = {
  shinAngle: {
    20: { good: 42, warn: 30, label: "Target ≥40°" },
    30: { good: 40, warn: 28, label: "Target ≥38°" },
    40: { good: 38, warn: 26, label: "Target ≥36°" },
    50: { good: 36, warn: 24, label: "Target ≥34°" },
    60: { good: 32, warn: 20, label: "Target ≥30°" },
    source: "Screening range based on weight-bearing dorsiflexion literature",
    capacity: true, unit: "°", max: 60,
  },
  shoulderTilt: {
    20: { good: 2, warn: 4, label: "Target <2°" }, 30: { good: 2, warn: 4, label: "Target <2°" },
    40: { good: 2, warn: 4, label: "Target <2°" }, 50: { good: 2, warn: 5, label: "Target <2°" },
    60: { good: 3, warn: 6, label: "Target <3°" },
    source: "Postural screen reference range",
  ...
  headLean: {
    20: { good: 3, warn: 6, label: "Target <3°" }, 30: { good: 3, warn: 6, label: "Target <3°" },
    40: { good: 3, warn: 7, label: "Target <3°" }, 50: { good: 4, warn: 8, label: "Target <4°" },
    60: { good: 5, warn: 10, label: "Target <5°" },
    source: "Postural screen reference range",
    capacity: false, unit: "°", max: 20,
  },
  fwdHead: {
    20: { good: 8, warn: 14, label: "Target <8°" }, 30: { good: 8, warn: 14, label: "Target <8°" },
    40: { good: 9, warn: 15, label: "Target <9°" }, 50: { good: 10, warn: 18, label: "Target <10°" },
    60: { good: 12, warn: 20, label: "Target <12°" },
    source: "Postural screen reference range",
    capacity: false, unit: "°", max: 35,
  },
  shoulderRound: {
    20: { good: 5, warn: 10, label: "Target <5°" }, 30: { good: 5, warn: 10, label: "Target <5°" },
    40: { good: 6, warn: 12, label: "Target <6°" }, 50: { good: 7, warn: 14, label: "Target <7°" },
    60: { good: 8, warn: 16, label: "Target <8°" },
    source: "Postural screen reference range",
    capacity: false, unit: "°", max: 35,
  },
  torsoLean: {
    20: { good: 30, warn: 45, label: "Target <30°" }, 30: { good: 30, warn: 45, label: "Target <30°" },
    40: { good: 32, warn: 47, label: "Target <32°" }, 50: { good: 35, warn: 50, label: "Target <35°" },
    60: { good: 38, warn: 55, label: "Target <38°" },
    source: "Squat/hinge screen reference range",
    capacity: false, unit: "°", max: 90,
  },
  weightShift: {
    20: { good: 4, warn: 8, label: "Target <4%" }, 30: { good: 4, warn: 8, label: "Target <4%" },
    40: { good: 4, warn: 8, label: "Target <4%" }, 50: { good: 5, warn: 10, label: "Target <5%" },
    60: { good: 5, warn: 10, label: "Target <5%" },
    source: "Movement symmetry screen reference range",
